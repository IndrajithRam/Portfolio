...
export default function About() {
  ...
  return (
    ...
    <main className="container" style={{ textAlign: 'center' }}>
      ...
      <h1 className="display-5 fw-medium" style={{marginTop: "1rem", marginBottom: "3rem", color: "#f04343"}}>About Me</h1>
      ...
      <div className="row">
        ...
        <div className="col-md-7 col-lg-7">
          ...
          <a href="/IndrajithRamLoganathan_Resume.pdf" download="IndrajithRamLoganathan_Resume.pdf" style={{ width: "200px", marginTop: "2rem", marginBottom: "2rem" }} className="btn btn-light"> Download Resume </a>
